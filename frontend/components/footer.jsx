            ...
            <div className="footer-container">
                    <Link to='/'>
                        ...
                        <div className="footer-socials">
                            <a href="https://www.linkedin.com/in/lauren-hyuna-lee/" className="footer-social"><i className="fab fa-linkedin"></i></a>
                            <a href="https://github.com/hyunalee625" className="footer-social"><i className="fab fa-github"></i></a>
                            <a href="http://laurenhlee.com/" className="footer-social"><i className="fas fa-user"></i></a>  
                        </div>
